...
const CustomerRegister = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/api/signup/customer', data);
        ...
        <div className="flex items-center justify-center min-h-screen" style={{ backgroundImage: `url(${BGURL})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <div className='flex w-3/5 h-[70vh] bg-white rounded-xl  overflow-hidden'>
                ...
                <div className='w-1/2 flex flex-col justify-center p-8'>
                    <Typography variant="h4" className="font-bold mb-4 text-black text-5xl font-roboto">Customer Registration</Typography>
                    <Typography variant="body2" className="mb-8 ">
                        have an account? <a href="/customer/Login" className='text-blue-500'>Sign in</a>, it takes less than a minute.
                    </Typography>
