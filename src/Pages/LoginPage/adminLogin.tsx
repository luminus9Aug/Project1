...
const AdminLogin = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (validateForm()) {
            try {
                const response = await axios.post('http://localhost:3001/api/login/admin', formData);
        ...
        <main className="flex items-center justify-center min-h-screen" style={{ backgroundImage: `url(${BGURL})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <div className="flex w-3/5 h-[70vh] bg-white rounded-xl overflow-hidden">
                ...
                <div className="w-1/2 flex flex-col justify-center p-8">
                    <Typography variant="h4" className="font-bold mb-4 text-black text-5xl font-roboto">Login as Admin <a href="/customer/Login"><SyncAltIcon /></a></Typography>
                    <Typography variant="body2" className="mb-8">
                        Don’t have an account? <a href="/admin/register" className="text-blue-500">Create your account</a>, it takes less than a minute.
                    </Typography>
